...
class Model{
  ...
  // Funciones para tablas intermedias (relaciones muchos a muchos)
  public function attach($pivotTable, $data)
  {
    // INSERT INTO pivot_table (foreign_key, related_key) VALUES ('value1', 'value2')
    $columns=array_keys($data);
    $columns= implode(',',$columns);
  ...
  {
    // DELETE FROM pivot_table WHERE foreign_key = 'value1' AND related_key = 'value2'
    $conditions = [];
    foreach ($data as $key => $value) {
